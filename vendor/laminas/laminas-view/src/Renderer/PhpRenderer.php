 ...
 * @method string translate(string $message, string $textDomain = null)
 * @method void addTranslationFile(string $textDomain, string $dir)
 * @method string getLanguage()
 * @method mixed params(string $name = null)
 */
